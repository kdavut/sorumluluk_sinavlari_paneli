...
3. Sınavların Tanımlanması (Sınav Girişi Sekmesi)

- Ders ve Seviye: Sınavı yapılacak dersi ve sınıf seviyesini seçin.

- Görevli Atama: Sistem, seçtiğiniz tarih ve saatte başka bir sınavda görevi olan öğretmenleri listede göstermez (Çakışma Kontrolü).

- Komisyon ve Gözetmen: İhtiyaca göre görevli sayılarını artırıp azaltabilirsiniz.

4. Takip ve İstatistikler (Görev Sayıları Sekmesi)

- Bu sekmeden hangi öğretmenin kaç komisyon, kaç gözetmenlik görevi aldığını anlık olarak görebilirsiniz.

- Adil bir görev dağılımı yapmak için "Toplam" sütununu takip edebilirsiniz.

5. Yazdırma ve Tebliğ (Görev Kağıdı Sekmesi)

- Tekli Yazdır: İstediğiniz öğretmenin görev belgesini hazırlar.

- Tümünü Yazdır: Tüm görevli öğretmenlerin belgelerini arka arkaya, her öğretmen yeni bir sayfaya gelecek şekilde PDF olarak hazırlar.
...
-- Geri Yükle: Daha önce aldığınız yedek dosyasını sisteme geri yükler.

-- Sıfırla: Yeni bir sınav dönemi başlangıcında tüm eski kayıtları temizlemek için kullanılır.
